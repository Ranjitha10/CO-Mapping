...
//distinct student usn taken up the test
$noofstu="SELECT COUNT(DISTINCT `usn`) AS cnt FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test'";
...
$count1=0;
$m1=0;
$query="SELECT `ques_num`, `max_marks` FROM `eval_questions` WHERE `c_code_evq`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO1'";
$result=mysqli_query($connect,$query);
while($row=mysqli_fetch_assoc($result)){
	$m1=$m1+$row["max_marks"];
	$i=$row["ques_num"];
	$q1="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$i'";
...
$queryth="SELECT `ques_num`, `max_marks` FROM `eval_theory_ques` WHERE `c_code`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO1'";
$resultth=mysqli_query($connect,$queryth);
while($rowt=mysqli_fetch_assoc($resultth)){
	$m1=$m1+$rowt["max_marks"];
	$it=$rowt["ques_num"];
	$qth1="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$it'";
...
$count2=0;
$m2=0;
$query2="SELECT `ques_num`, `max_marks` FROM `eval_questions` WHERE `c_code_evq`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO2'";
$result2=mysqli_query($connect,$query2);
while($row2=mysqli_fetch_assoc($result2)){
	$m2=$m2+$row2["max_marks"];
	$i=$row2["ques_num"];
	$q2="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$i'";
...
$queryth2="SELECT `ques_num`, `max_marks` FROM `eval_theory_ques` WHERE `c_code`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO2'";
$resultth2=mysqli_query($connect,$queryth2);
while($rowt2=mysqli_fetch_assoc($resultth2)){
	$m2=$m2+$rowt2["max_marks"];
	$it=$rowt2["ques_num"];
	$qth2="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$it'";
...
$count3=0;
$m3=0;
$query3="SELECT `ques_num`, `max_marks` FROM `eval_questions` WHERE `c_code_evq`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO3'";
$result3=mysqli_query($connect,$query3);
while($row3=mysqli_fetch_assoc($result3)){
	$m3=$m3+$row3["max_marks"];
	$i=$row3["ques_num"];
	$q3="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$i'";
...
$queryth3="SELECT `ques_num`, `max_marks` FROM `eval_theory_ques` WHERE `c_code`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO3'";
$resultth3=mysqli_query($connect,$queryth3);
while($rowt3=mysqli_fetch_assoc($resultth3)){
	$m3=$m3+$rowt3["max_marks"];
	$it=$rowt3["ques_num"];
	$qth3="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$it'";
...
$count4=0;
$m4=0;
$query4="SELECT `ques_num`, `max_marks` FROM `eval_questions` WHERE `c_code_evq`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO4'";
$result4=mysqli_query($connect,$query4);
while($row4=mysqli_fetch_assoc($result4)){
	$m4=$m4+$row4["max_marks"];
	$i=$row4["ques_num"];
	$q4="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$i'";
...
$queryth4="SELECT `ques_num`, `max_marks` FROM `eval_theory_ques` WHERE `c_code`='$cc' && `type`='Test' && `eval_num`='$en' && `co_level`='CO4'";
$resultth4=mysqli_query($connect,$queryth4);
while($rowt4=mysqli_fetch_assoc($resultth4)){
	$m4=$m4+$rowt4["max_marks"];
	$it=$rowt4["ques_num"];
	$qth4="SELECT `marks_scored` FROM `stu_attainment` WHERE `c_code_attain`='$cc' && `eval_num_appear`='$en' && `type_appear`='Test' && `ques_num_appear`='$it'";
...
$tm1=$m1*$scount;//multiplication-no of students attended the test*max co1 marks in each paper
$tm2=$m2*$scount; //total co marks
$tm3=$m3*$scount;
$tm4=$m4*$scount;
...
$perco1=($count1*100)/$tm1;
$perco2=($count2*100)/$tm2;
$perco3=($count3*100)/$tm3;
$perco4=($count4*100)/$tm4;
    ...
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_half first"> 
		 ...
		 <h2>CO Attainment</h2>
                       <p>Bar Chart for <?php echo $cc;?> & Evaluation number <?php echo $en;?></p>
